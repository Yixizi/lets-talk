// Enable React Server Components in Next.js
"use client";
...
const MyRoomPage = () => {
  ...
  return (
    ...
    <section className="flex size-full flex-col gap-10 text-white animate-fade-in">
      {/* Page title */}
      <h1 className="text-xl font-bold lg:text-3xl">个人会议房间</h1>
      ...
      <div className="flex w-full flex-col gap-8 xl:max-w-[900px]">
        ...
        />
        <PersonalMeetingInfo title="会议号" description={meetingId!} />
        <PersonalMeetingInfo title="邀请链接" description={meetingLink} />
      </div>
